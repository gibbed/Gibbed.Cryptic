...
namespace Gibbed.Cryptic.ExportSchemas
{
    internal static class Locator
    {
        ...
        public static uint FindExpressionFunctionTable(ProcessMemory memory)
        {
            ...
            sb.Append("83 EC 50 ");
            sb.Append("53 56 57 ");
            sb.Append("C7 45 FC 00 00 00 00 8D 45 FC 50 8B 4D 08 51 ");
            sb.Append("E8 xx xx xx xx ");
            sb.Append("83 C4 04 50 ");
            sb.Append("8B 15 xx xx xx xx ");
            sb.Append("52 ");
            sb.Append("E8 xx xx xx xx ");
            sb.Append("83 C4 0C 83 7D FC 00 ");
            ...
            var pointer = memory.ReadU32(codeOffset + 35);
            if (pointer == 0)
            {
                throw new InvalidOperationException();
            }
        ...
        public static uint FindOldExpressionFunctionTable(ProcessMemory memory)
        {
            StringBuilder sb;

            sb = new StringBuilder();
            sb.Append("55 8B EC ");
            sb.Append("81 EC F0 00 00 00 ");
            sb.Append("53 56 57 ");
