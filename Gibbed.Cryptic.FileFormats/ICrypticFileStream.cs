...
{
    public interface ICrypticFileStream
    {
        ...
        void SerializeValueByteEnum<TType>(ref TType value);
        void SerializeArrayByteEnum<TType>(ref TType[] array, int count);
        void SerializeListByteEnum<TType>(ref List<TType> list);

        void SerializeValueInt16Enum<TType>(ref TType value);
        void SerializeArrayInt16Enum<TType>(ref TType[] array, int count);
        void SerializeListInt16Enum<TType>(ref List<TType> list);

        void SerializeValueInt32Enum<TType>(ref TType value);
        void SerializeArrayInt32Enum<TType>(ref TType[] array, int count);
        void SerializeListInt32Enum<TType>(ref List<TType> list);

        void SerializeValueBitEnum<TType>(ref TType value);
        void SerializeArrayBitEnum<TType>(ref TType[] array, int count);
        void SerializeListBitEnum<TType>(ref List<TType> list);
    }
}
