...
{
    internal class Filename : BasicStringToken
    {
        public override string NameDirectValue { get { return "FIXEDFILENAME"; } }
        public override string NameIndirectValue { get { return "FILENAME"; } }
