...
namespace Gibbed.Cryptic.GenerateSerializer
{
    internal class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var showHelp = false;
            string version = null;
            string inputPath = Path.Combine(binPath, "..", "configs", "schemas", "Star Trek Online", "Live");
            string targetGameName = "StarTrekOnline";
            ...
            var parseLoader = new ParseLoader(inputPath);
            ...
            new Generator(targetGame, parseLoader, enumLoader).ExportAssembly(outputPath, version);
        }
    }
}
