...
namespace Gibbed.Cryptic.ExportSchemas.Natives.x32
{
    ...
    internal struct ExpressionArgument
    {
        ...
        public x64.ExpressionArgument Upgrade()
        {
            return new x64.ExpressionArgument()
            {
                Type = this.Type,
                NamePointer = new IntPtr(this.NamePointer),
                StaticCheckTypePointer = new IntPtr(this.StaticCheckTypePointer),
                Unknown = new IntPtr(this.Unknown),
                AllowNullPointer = this.AllowNullPointer,
                TypeCategory = this.TypeCategory,
                TypeNamePointer = new IntPtr(this.TypeNamePointer),
            };
        }
    }
}
