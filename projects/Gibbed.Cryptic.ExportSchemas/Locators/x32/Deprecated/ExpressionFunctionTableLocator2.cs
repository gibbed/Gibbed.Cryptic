...
{
    internal static class ExpressionFunctionTableLocator2
    {
        public static bool Locate(RuntimeProcess runtime, out IntPtr result)
        {
            ...
            var pointer1 = runtime.ReadValueU32(codeOffset + 3);
            if (pointer1 == 0)
            {
                throw new InvalidOperationException();
            }

            var pointer2 = runtime.ReadValueU32(codeOffset + 53);
            if (pointer2 == 0)
            {
                throw new InvalidOperationException();
            }
