...
namespace Gibbed.Cryptic.FileFormats.Serialization
{
    public interface IBaseWriter
    {
        ...
        void WriteListFunctionCall(List<FunctionCall> list, int maxCount, object state);
        ...
        void WriteListStructure<TType>(List<TType> list, int maxCount, object state) where TType : IStructure, new();
        ...
        void WriteListPolymorph(List<object> list, Type[] validTypes, int maxCount, object state);

        void WriteValueStashTable(StashTable value, object state);
        void WriteArrayStashTable(StashTable[] array, int count, object state);
        void WriteListStashTable(List<StashTable> list, int maxCount, object state);
        ...
        void WriteListBitEnum<TType>(List<TType> list, int bitOffset, int maxCount, object state);
    }
}
