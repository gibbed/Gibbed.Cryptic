...
{
    public class ParseEnumFile
    {
        public string Name;
        public ParseSchema.Enumeration Enum;

        private ParseEnumFile()
        {
        }

        public static ParseSchema.Enumeration LoadEnumeration(XPathNavigator nav)
        {
            var elements = new ParseSchema.Enumeration();
            ...
            switch (type)
            {
                case "int":
                {
                    elements.Type = ParseSchema.EnumerationType.Int;
                    break;
                }

                case "string":
                {
                    elements.Type = ParseSchema.EnumerationType.String;
                    break;
                }
        ...
        public static ParseEnumFile LoadFile(string path)
        {
